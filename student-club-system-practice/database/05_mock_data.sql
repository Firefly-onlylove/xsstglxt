...
INSERT INTO activities (activity_id, club_id, title, description, type, start_time, end_time, reg_deadline, location, max_participants, status, signin_code, created_by) VALUES
...
(2, 1, '动态规划专题训练', '深度讲解动态规划经典题型，从记忆化搜索到状态压缩DP，含实战训练环节。',
    '培训', '2026-04-10 09:00:00', '2026-04-10 12:00:00', '2026-04-09 18:00:00', '信科院实验楼A201', 40, 'finished', 'D4E5F6', 101),
...
(5, 2, '敬老院慰问活动', '前往市养老院进行慰问演出和陪伴活动，传递社会温暖与关爱。',
    '公益', '2026-05-15 08:00:00', '2026-05-15 16:00:00', '2026-05-14 18:00:00', '市养老院', 25, 'finished', 'F0A1B2', 102),
...
(8, 3, '天文知识科普讲座', '邀请物理系教授讲解黑洞、引力波等前沿天文知识，面向全校师生开放。',
    '讲座', '2026-06-20 14:00:00', '2026-06-20 17:00:00', '2026-06-19 18:00:00', '理学院报告厅', 80, 'finished', 'J6K7L8', 106);
...
(14, 6, '文学经典读书会——《百年孤独》', '共同阅读马尔克斯经典作品，探讨魔幻现实主义文学的魅力。',
    '读书会', '2026-06-05 18:30:00', '2026-06-05 20:30:00', '2026-06-04 18:00:00', '文学院阅览室', 20, 'finished', 'S5T6U7', 103);
...
(16, 8, '校园创业计划大赛宣讲会', '介绍创业计划大赛的参赛流程和评审标准，邀请往届获奖团队分享经验。',
    '宣讲', '2026-05-20 15:00:00', '2026-05-20 17:00:00', '2026-05-20 12:00:00', '经管院教学楼A101', 60, 'finished', 'Y1Z2A3', 105);
...
INSERT INTO registrations (activity_id, user_id, status, signin_time) VALUES
(2, 202, 'signed_in', '2026-04-10 08:55:00'),
(2, 203, 'signed_in', '2026-04-10 08:58:00'),
(2, 205, 'signed_in', '2026-04-10 09:02:00'),
(2, 208, 'signed_in', '2026-04-10 09:00:00'),
(2, 211, 'cancelled', NULL),
(2, 214, 'cancelled', NULL),
(2, 233, 'signed_in', '2026-04-10 08:50:00'),
(2, 235, 'signed_in', '2026-04-10 09:05:00'),
(2, 239, 'signed_in', '2026-04-10 08:45:00'),
(2, 255, 'signed_in', '2026-04-10 08:52:00');
...
INSERT INTO registrations (activity_id, user_id, status, signin_time) VALUES
(5, 206, 'signed_in', '2026-05-15 07:50:00'),
(5, 209, 'signed_in', '2026-05-15 07:55:00'),
(5, 212, 'signed_in', '2026-05-15 08:00:00'),
(5, 234, 'signed_in', '2026-05-15 07:48:00'),
(5, 244, 'signed_in', '2026-05-15 07:52:00'),
(5, 265, 'signed_in', '2026-05-15 07:55:00');
...
INSERT INTO registrations (activity_id, user_id, status, signin_time) VALUES
(8, 207, 'signed_in', '2026-06-20 13:50:00'),
(8, 210, 'signed_in', '2026-06-20 13:55:00'),
(8, 215, 'signed_in', '2026-06-20 14:00:00'),
(8, 237, 'signed_in', '2026-06-20 13:52:00'),
(8, 258, 'signed_in', '2026-06-20 13:58:00'),
...
INSERT INTO registrations (activity_id, user_id, status, signin_time) VALUES
(10, 201, 'signed_in', '2026-07-18 15:55:00'),
(10, 204, 'signed_in', '2026-07-18 15:58:00'),
(10, 229, 'signed_in', '2026-07-18 16:00:00'),
...
INSERT INTO registrations (activity_id, user_id, status, signin_time) VALUES
(14, 222, 'signed_in', '2026-06-05 18:25:00'),
(14, 223, 'signed_in', '2026-06-05 18:28:00'),
(14, 226, 'signed_in', '2026-06-05 18:30:00'),
(14, 227, 'signed_in', '2026-06-05 18:26:00'),
(14, 231, 'signed_in', '2026-06-05 18:29:00');
...
INSERT INTO registrations (activity_id, user_id, status, signin_time) VALUES
(16, 254, 'signed_in', '2026-05-20 14:50:00'),
(16, 256, 'signed_in', '2026-05-20 14:55:00'),
(16, 259, 'signed_in', '2026-05-20 15:00:00'),
(16, 260, 'signed_in', '2026-05-20 14:52:00'),
(16, 263, 'signed_in', '2026-05-20 14:58:00');
...
(1, 1, 'ACM编程协会2026年换届选举', 'president_vice', '2026-03-01 00:00:00', '2026-03-10 23:59:59', 'finished', 101, 15),
...
-- 文学创作社：已结束
INSERT INTO elections (election_id, club_id, title, election_type, start_time, end_time, status, winner_id, total_votes) VALUES
(4, 6, '文学创作社2026年换届选举', 'president_vice', '2026-03-05 00:00:00', '2026-03-15 23:59:59', 'finished', 103, 8);
...
-- 社团通知（ACM编程协会全体成员）
INSERT INTO notifications (user_id, title, content, type, related_club_id, is_read) VALUES
...
INSERT INTO notifications (user_id, title, content, type, related_activity_id, is_read) VALUES
...
-- ================================================================
-- 修正活动报名人数
UPDATE activities a SET current_participants = (SELECT COUNT(*) FROM registrations r WHERE r.activity_id = a.activity_id AND r.status != 'cancelled');
