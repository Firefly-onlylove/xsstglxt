...
STUB_HANDLER(sch_college_list)
STUB_HANDLER(sch_college_create)
STUB_HANDLER(sch_college_update)
STUB_HANDLER(sch_college_toggle)
STUB_HANDLER(sch_major_list)
STUB_HANDLER(sch_major_create)
STUB_HANDLER(sch_major_update)
STUB_HANDLER(sch_major_delete)
...
STUB_HANDLER(club_finance_list)
STUB_HANDLER(club_reimb_list)
STUB_HANDLER(club_reimb_create)
