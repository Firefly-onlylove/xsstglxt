...
(2, 1, '动态规划专题训练', '深度讲解动态规划经典题型，从记忆化搜索到状态压缩DP，含实战训练环节。',
    '2026-04-10 09:00:00', '2026-04-10 12:00:00', '2026-04-09 18:00:00', '信科院实验楼A201', 40, 'completed', 'D4E5F6'),
...
(5, 2, '敬老院慰问活动', '前往市养老院进行慰问演出和陪伴活动，传递社会温暖与关爱。',
    '2026-05-15 08:00:00', '2026-05-15 16:00:00', '2026-05-14 18:00:00', '市养老院', 25, 'completed', 'F0A1B2'),
...
SELECT CONCAT('报销申请总数：', COUNT(*)) AS total_reimbursements FROM reimbursement;
